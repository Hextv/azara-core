...
RACE_INFO_DWARF = "Forged by mountain and time, the dwarves are a resolute people whose courage is as enduring as the stone they dwell within. Renowned miners and master smiths, they carve wealth and weapons from the deep earth. Above all, they are bound by ironclad loyalty, a unity no shadow has yet shattered."
RACE_INFO_DWARF_FEMALE = "Forged by mountain and time, the dwarves are a resolute people whose courage is as enduring as the stone they dwell within. Renowned miners and master smiths, they carve wealth and weapons from the deep earth. Above all, they are bound by ironclad loyalty, a unity no shadow has yet shattered."
...
RACE_INFO_HUMAN = "Curious and determined, humans are builders and thinkers. They spread across the lands of Arcadia, founding cities and kingdoms through effort and planning. Though their weapons are not always the finest, their greatest strength lies in discipline and tactics. In battle, careful strategy and preparation often overcome raw strength."
RACE_INFO_HUMAN_FEMALE = "Curious and determined, humans are builders and thinkers. They spread across the lands of Arcadia, founding cities and kingdoms through effort and planning. Though their weapons are not always the finest, their greatest strength lies in discipline and tactics. In battle, careful strategy and preparation often overcome raw strength."
RACE_INFO_NIGHTELF = "Hidden within the oldest forests of Azara, the Wood Elves are a quiet and watchful people, bound to the rhythms of the wild. They are unmatched hunters and archers, moving as animals among the trees. Through ancient herbal rites and natural alchemy, they wield quiet magic drawn from leaf, root, and spirit."
